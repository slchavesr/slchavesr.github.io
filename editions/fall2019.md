...
<p style='text-align: justify;'>
In 1939 A. A. Albert published in *Structures of algebras* a proof that given a central simple algebra $A$ over a field $K$, $A$ has an involution of the first kind if and only if its class in the Brauer group of $K$ has order $1$ or $2$.
In this talk we will introduce, following Giraud (1971), a categorical analogue of a principal vector bundle, called $G$-*gerbe*, as well as the notion of *twisted vector bundle* as defined in the work of Lieblich (2004).
